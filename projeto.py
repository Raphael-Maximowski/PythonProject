...
class Validador:
    ...
    def validar_cadastro(self, nome_input, email_input, cpf_input, password_input):
        # Verifica CPF
        ...
        # Se o CPF e Email não existir, cadastra o novo usuário
    ...
    def exibir_historico(self):
        ...
        for venda in self.vendas:
            ...
            for item in venda['itens']:
                print(f"- {item['produto']['Produto']} (Código: {item['produto']['Code']}) - Quantidade: {item['quantidade']} - Valor Unitário: R${item['produto']['Valor']:.2f}")
...
class Carrinho:
    ...
    def exibir_carrinho(self):
        ...
        for item in self.itens:
            ...
            total += valor
            print(f'{code} - {produto["Produto"]} - Quantidade: {quantidade} - Valor unitário: R${produto["Valor"]:.2f}')
...
def sign_up(gerenciador):
    ...
    # Valida o cadastro
    resultadoValidacao = validador.validar_cadastro(nome_input, email_input, cpf_input, password_input)
                                    ...
                                    while True:
                                        ...
                                        if input_user == 1:
                                            while True:
                                                ...
                                                continuar = input("Deseja adicionar outro item ao carrinho? (s/n): ").strip().lower()
                                                if continuar != 's':
